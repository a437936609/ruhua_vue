		...
		<view class="t">
			<block v-for="(item,index) of list" :key="index">
				<li class="t_01">
					...
					<view class="t_01_2">
						<view>
							<img v-if="item.agent.headpic" :src="item.agent.headpic"></img>
							<image style="width: 30px;height: 30px;margin-top: 10px;margin-right: 10px;" v-else src="../../../static/img/head.png" mode=""></image>
						</view>
						<view class="name_1">
							{{item.agent.nickname?item.agent.nickname:'无昵称'}}
						</view>
					</view>
