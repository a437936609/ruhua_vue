...
//分类商品
function getProductCate(index,page){ 
	let url='product/get_cate_pros?id='+index+'&page='+page
...
//热门推荐
function getProductHotRecent(page){ 
	let url='product/get_recent'
	return http.get(url,{type:'hot',page:page}).then(res=>{
		return res;
	})
}
//新品推荐
