<template>
	<div class="root">
		...
		text-color="#fff" active-text-color="#ffd04b" @select="handleSelect" > 
			...
			<el-submenu index="5">
				...
				<el-menu-item-group>
					...
					<el-menu-item index="5-3" @click="jump_data">
						<span slot="title" style="margin-left: 40px;">财务&统计</span>
					</el-menu-item>
				</el-menu-item-group>
			</el-submenu>
		...
		<!--	<el-submenu index="7">
			...
			<el-menu-item index="8" @click="jump_app">
			...
			<el-submenu index="10">
				...
				<el-menu-item-group>
					...
					<el-menu-item index="10-2" @click="jump_other_set">
						<span slot="title" style="margin-left: 40px;">其它设置</span>
					</el-menu-item>
					...
					<el-menu-item index="10-5" @click="jump_mould">
						<span slot="title" style="margin-left: 40px;">模板消息</span>
					</el-menu-item>
					<el-menu-item index="10-6" @click="jump_mould_ys">
						<span slot="title" style="margin-left: 40px;">隐私政策</span>
					</el-menu-item> -->
