		...
		data() {
			return {
				...
				list: [{
						id: 1,
						name: '签到',
						url: '/means/qiandao/qiandao'
					},
					{
						id: 2,
						name: '积分',
						url: '/means/point/point'
					},
					{
						id: 3,
						name: '秒杀',
						url: '/means/miaosha/miaosha'
					},
					{
						id: 4,
						name: '限时折扣',
						url: '/means/discount/discount'
					},
					{
						id: 16,
						name: '一元团购',
						url: '/means/onebuy/onebuy'
					},
					{
						id: 5,
						name: '拼团',
					...
					},
					{
						id: 7,
						name: '文章',
						url: '/pages/article/article?id='
					},
					{
						id: 8,
						name: '优惠券',
						url: '/means/coupon/coupon',
					...
					// 	id: 11,
					// 	name: '大转盘',
					// 	url: '/means/play/activity/draw'
					// },
					// {
					// 	id: 12,
					// 	name: '九宫格',
					// 	url: '/means/play/sherpa-jiugongge/sherpa-jiugongge'
					// },
					{
						id: 13,
						name: '种树',
						url: '/means/play/watering/watering'
					},
					{
						id: 15,
						name: '分类',
