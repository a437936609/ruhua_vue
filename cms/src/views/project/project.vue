		...
		methods: {
			...
			del(id) {
				this.$confirm('确定删除?', '提示', {
					...
					this.http.put_show('project/admin/del_project?id='+id).then(res => {
						this.$message({
							type: 'success',
							message: '删除成功!'
						});
			...
			onSubmit() {
				...
				this.http.post_show('project/admin/add_project', this.form).then(res => {
					this.$message({
						message: '添加成功',
						type: 'success'
					});
			...
			sub_edit() {
				this.$confirm('确定修改?', '提示', {
					...
					this.http.post_show('project/admin/edit_project', this.form).then(res => {
						this.$message({
							type: 'success',
							message: '修改成功!'
						});
