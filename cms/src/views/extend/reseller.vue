		...
		<el-container>
			...
			<el-container>
				...
				<transition appear appear-active-class="animated fadeInLeft">
					<el-main>
						<div class="article">
							<el-button  @click="jumpback">返回</el-button> &emsp;<el-button type="primary" @click="add_user">添加分销商品</el-button>
							<el-button type="primary" @click="fx_user_manage">分销商管理</el-button>
							<div style="height:20px;">&nbsp;</div>
							<el-table :data="list" border>
								<el-table-column type="index" label="序号" width="50px"></el-table-column>
								<el-table-column prop="goodsInfo.goods_name" label="商品名称" width="400"></el-table-column>
								<el-table-column prop="goodsInfo" label="图片" width="110">
									<template slot-scope="scope">
										<template v-if="scope.row.goodsInfo">
											<img :src="$getimg + scope.row.goodsInfo.imgs" />
										</template>
									</template>
								</el-table-column>
								<el-table-column prop="goodsInfo.price" label="商品价格" width="100"></el-table-column>
								...
								<el-table-column prop="operation" label="操作">
									<template slot-scope="scope">
										<el-button @click="edit(scope.row.id,scope.row.price,scope.row.goodsInfo.price)" type="success" size="small">修改</el-button>
