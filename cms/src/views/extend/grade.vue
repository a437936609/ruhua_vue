              ...
              <el-tabs v-model="activeName" v-if="form_list[0].value == 1">
                <el-tab-pane label="列表" name="1">
                  <div class="fx-con">
					...
					<el-table-column prop="award" label="奖励" width="380"></el-table-column>
                   
                      </el-table-column>

                      <el-table-column prop="operation" label="操作">
                        <template slot-scope="scope">
                          <el-button @click="edit_get(scope.row.id,scope.row.award)" type="success" size="small">修改</el-button>
					...
					<el-dialog title="修改奖励" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
...
export default {
  ...
  methods: {
    ...
    get_config() {
      this.http.post_show("cms/get_config?type=12").then((res) => {
    ...
    get_wntable() {
      var that = this;
      this.http.get("cms/play_award/get").then((res) => {
        that.list = res.data;
