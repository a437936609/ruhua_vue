...
class AdminVerifyService
{
    ...
    public function create(string $config = null, bool $api = false)
    {
     ...
     //   $this->imageH || $this->imageH = $this->fontSize * 2.5;
        ...
        // 验证码使用随机字体
        $ttfPath = ROOT.'/static/verify/assets/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/';
    ...
    protected function writeNoise(): void
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            for ($j = 0; $j < 5; $j++) {
                // 绘杂点
                imagestring($this->im, 5, mt_rand(-10, $this->imageW), mt_rand(-10, $this->imageH), $codeSet[mt_rand(0, 4)], $noiseColor);
            }
        }
    }
    ...
    protected function background(): void
    {
       // $path = __DIR__ . '/../assets/bgs/';
        $path=ROOT."/static/verify/assets/bgs/";
